...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/MechanicPolygon_VK.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/MechanicPolygon_VK.data.unityweb',
                        frameworkUrl: 'Build/MechanicPolygon_VK.framework.js.unityweb',
                        codeUrl: 'Build/MechanicPolygon_VK.wasm.unityweb',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'Matt.car.crash.simulator.mechanik',
                        productName: 'CarMechanicXRaceSimulator',
                        productVersion: '5.0',
